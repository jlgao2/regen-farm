...
export const MICROSEASONS = [
  ...
  {
    id: 'djeran-paengaherehere',
    name: 'Djeran · Paenga-ā-Tāhūrangi',
    subtitle: 'The cooling shift — winds turn south',
    start: { month: 4,  day: 15 },
    end:   { month: 5,  day: 15 },
    standardSeasons: ['autumn'],
    heritage: [
      { term: 'Djeran', nation: 'Noongar', meaning: 'season of change — south wind returns; mornings carry first chill' },
      { term: 'Paenga-ā-Tāhūrangi', nation: 'Māori', meaning: 'the plantations are cleared to the borders; root crops lifted' },
    ],
    indicators: [
      'Red Flowering Gum seeds ripe; honeyeaters concentrated (WA)',
      'Mornings consistently below 12 °C in tablelands',
      'First mushroom flush — Saffron Milk Caps emerge in pine shelter-belts',
      'Wind direction shifts to south-southwest (SE Aus, Apr–May)',
      'Soil temp falling through 15 °C — warm-season root growth ends',
      'Eel numbers peak in lowland rivers (Tuna migration intensifies)',
      'Djeran birds (Carnaby\'s Black Cockatoo) moving in flocks across WA',
    ],
    tohu: 'South wind returns — the land tilts its face away from the sun; fungi emerge as bacteria retreat',
    farming: 'Plant autumn brassicas, alliums, and winter greens directly into soil. Last inoculation window for mycorrhizal fungi before soil cools below 12 °C. Build compost heaps before heavy rain makes turning difficult. Sow cover crops on resting ground.',
    accent: '#b06028',
  },
  {
    id: 'makuru-paenga',
  ...
  {
    id: 'matariki-pipiri',
    name: 'Matariki · Pipiri',
    subtitle: 'The Pleiades rise — new year read in stars',
    start: { month: 6,  day: 15 },
    end:   { month: 7,  day: 12 },
    standardSeasons: ['winter'],
    heritage: [
      { term: 'Matariki', nation: 'Māori', meaning: 'eyes of god / tiny eyes — Pleiades heliacal rise marks the new year' },
      { term: 'Pipiri', nation: 'Māori', meaning: 'the cold drives creatures to seek shelter; month of Matariki' },
    ],
    indicators: [
      'Matariki (Pleiades) rises at dawn in the northeast (~late June)',
      'Puanga (Rigel) alternative new-year marker for some iwi (NZ)',
      'Winter solstice (Jun 20–22) — shortest day; light begins returning',
      'Heavy frosts on Canterbury Plains and Victorian tablelands',
      'Soil temp at 10 cm drops to 7–8 °C at lowland sites',
      'Wombats enter most sedentary period — burrow maintenance',
      'Kahikatea berries persist; Kererū and Tūī congregate to feed',
    ],
    tohu: 'Matariki clarity forecasts the year — bright stars mean warmth and abundance; hazy predicts cold and hardship',
    farming: 'Rest the soil entirely. Observe and plan. Cold-stratify fruit tree seeds. Read Matariki stars for seasonal forecast. Brew preparations: KNF Water Soluble Calcium (WSC) from egg shell + brown rice vinegar. Repair structures and sharpen tools. Plant garlic into cold soil.',
    accent: '#608cb8',
  },
  {
    id: 'waring-hotoke',
