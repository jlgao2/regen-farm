        ...
        tasks: [
          ...
          },
          {
            ...
            tools: [
              ...
              '200 L drum or IBC for charging slurry',
              'Vermicast, KNF FPJ, water',
              'Broadfork or rotary hoe (shallow setting only)',
            ],
          ...
          },
          {
            ...
            tools: [
              ...
              'High-fungal woody compost (12+ months aged)',
              ...
              'Refractometer (optional, to test brix of target plants pre/post as a biological efficacy indicator)',
            ],
        ...
        tasks: [
          {
            ...
            tools: [
              ...
              'Broadfork for bed preparation (never rototill in regenerative systems — it destroys fungal networks)',
              'Ramial woodchip mulch (70–100 mm depth)',
              'Vermicast for planting holes (50 g per hole)',
              'Mycorrhizal inoculant (granular, applied in planting hole for alliums and clover)',
            ],
        ...
        tasks: [
          {
            ...
            tools: [
              ...
              'Raw brown sugar',
              'Wheat bran',
              'Moisture meter or squeeze test familiarity',
          ...
          },
          {
            ...
            tools: [
              'Bokashi bins (minimum two, for rotation)',
              'EM-inoculated bokashi bran',
        ...
        tasks: [
          {
            ...
            tools: [
              'Hardwood biochar (avoid pine-based — lower CEC, potential terpene residues)',
              'Vermicast leachate or mature worm tea',
              'KNF Fish Amino Acid (FAA)',
              '200-litre drum or IBC tote for charging',
              'Broad fork (Meadow Creature or locally forged equivalent)',
              'Wheelbarrow',
              'Garden rake',
            ],
          ...
          },
          {
            ...
            tools: [
              ...
              'Mature fungal-dominant compost',
              'Oat flour (rolled oats ground fine), liquid humic acid, fish hydrolysate',
              'Microscope (ideally 400x) for quality-check — or send samples to Soil Food Web labs',
          ...
          },
          {
            ...
            tools: [
              'EM-1 concentrate (EMNZ in Aotearoa; EM Agriton or Sustainable Farming Solutions in AU)',
        ...
        tasks: [
          {
            ...
            tools: [
              ...
              'Charged biochar (from Task 1.1)',
              'AMF granular inoculant (Mycoroots NZ or Soil Biology Solutions AU)',
        ...
        tasks: [
          {
            ...
            tools: [
              'Bokashi buckets (minimum two for rotation — one filling while one ferments)',
        ...
        tasks: [
          ...
          },
          {
            ...
            tools: [
              ...
              'Appropriate rhizobium inoculant for clover species',
        ...
        tasks: [
          {
            ...
            tools: [
              '200L+ actively aerated compost tea brewer (e.g., Microbe Brewing Systems AU, or DIY IBC-based brewer with 40L/min air pump)',
              'Compound microscope (400x) for pre-application biological assurance',
              'Low-pressure diaphragm pump sprayer (no ball valves — they shear hyphae)',
              'Aged fungal compost (source: Biocast Australia, Gippsland; Living Earth, Christchurch; or on-farm woody windrow compost)',
              'Soil thermometer (100mm probe)',
            ],
          ...
          },
          {
            ...
            tools: [
              'Hardwood biochar (500–600°C pyrolysis), screened to <10mm',
              ...
              'Single-tine ripper, broad fork, or wheel hoe for banding',
              'Moisture meter or squeeze test skill',
            ],
          ...
          },
          {
            ...
            tools: [
              'Granular AMF inoculant (Rhizophagus irregularis dominant, ≥200 propagules/g)',
          ...
          },
          {
            ...
            tools: [
              'EM-1 concentrate (EMRO NZ; Teraganix/EM Australia)',
              'Unsulphured blackstrap molasses',
              '20–200L fermentation vessel with airlock',
              'pH meter or strips',
              'Knapsack or boom sprayer with non-chlorinated water source',
              'Refractometer (optional, for monitoring Brix of ferment)',
            ],
        ...
        tasks: [
          {
            ...
            tools: [
              ...
              'Rhizobial inoculant for clover species',
        ...
        tasks: [
          {
            ...
            tools: [
              'Fine-grade biochar (1–3mm particle size)',
              'Mycorrhizal inoculant (R. irregularis dominant blend)',
              'Activated EM-1 concentrate',
              'Unsulphured blackstrap molasses',
              '200L mixing drum or IBC tote',
          ...
          },
          {
            ...
            tools: [
              ...
              'Refractometer (to monitor Brix levels as a plant-health proxy)',
        ...
        tasks: [
          ...
          },
          {
            ...
            tools: [
              ...
              'Mycorrhizal inoculant (ecto- and endo- blend)',
        ...
        tasks: [
          {
            ...
            tools: [
              'Actively aerated compost tea brewer (commercial or DIY — 20L minimum)',
              '40L/min aquarium or pond air pump with gang valve',
              'Verified fungal-dominant thermal compost',
              ...
              'Microscope (100–400x) for quality verification (ideal, not essential)',
            ],
        ...
        tasks: [
          ...
          },
          {
            ...
            tools: [
              ...
              'Soil thermometer (probe type for 5cm depth readings)',
